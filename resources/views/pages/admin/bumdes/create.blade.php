...
@section('title')
    <title>Admin | Tambah Bumdes</title>
@endsection
            ...
            <div class="card-body px-4">
                <form action="{{ route('bumdes.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input class='form-control @error('judul') is-invalid @enderror' type='text' name='judul' id='judul' placeholder='Masukkan Judul Bumdes' value='{{ old('judul') }}' required />
                        @error('judul')
                    ...
                    <div class="form-group">
                        ...
                        <input class='form-control @error('thumbnail') is-invalid @enderror' type='file' name='thumbnail' id='thumbnail' placeholder='Thumbnail Bumdes' value='{{ old('thumbnail') }}' required />
                        @error('thumbnail')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
